...
<div id="_desktop_currency_selector">
  <div class="currency-selector dropdown js-dropdown">
    <span class="title_currency">{l s='Currency:' d='Shop.Theme'}</span>
    <span class="expand-more _gray-darker" data-toggle="dropdown">{$current_currency.sign} ({$current_currency.iso_code})</span>
