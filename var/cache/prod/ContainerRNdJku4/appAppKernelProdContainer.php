...
class appAppKernelProdContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('F70fYpESeI', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'sport', 'user' => 'root', 'password' => '', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))', 1013 => $this->getEnv('const:runtime:_PS_ALLOW_MULTI_STATEMENTS_QUERIES_')], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), $a, ['enum' => 'string']);
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('oxSRCg0SR9', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('d9kXhwXIoBipGDAMIyJ2nx1BcYotHMTo7UefRxZDo5949guRe0wkh3vOdDsPtxTC'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                74 => 'ybc_blog_free',
                75 => 'pleasewait',
                76 => 'ybc_productimagehover',
                77 => 'ets_megamenu',
                78 => 'ets_multilayerslider',
                79 => 'ets_reviewticker',
                80 => 'ets_purchasetogether',
                81 => 'ybc_newsletter',
                82 => 'ybc_themeconfig',
                83 => 'ybc_widget',
                84 => 'ybc_manufacturer',
                85 => 'ets_mailchimpsync',
            ],
            ...
            'modules_translation_paths' => [
                ...
                31 => (\dirname(__DIR__, 4).'/modules/psxdesign/translations'),
                32 => (\dirname(__DIR__, 4).'/modules/psxmarketingwithgoogle/translations'),
                33 => (\dirname(__DIR__, 4).'/modules/ps_accounts/translations'),
                34 => (\dirname(__DIR__, 4).'/modules/ps_brandlist/translations'),
                35 => (\dirname(__DIR__, 4).'/modules/ps_cashondelivery/translations'),
                36 => (\dirname(__DIR__, 4).'/modules/ps_categoryproducts/translations'),
                37 => (\dirname(__DIR__, 4).'/modules/ps_checkout/translations'),
                38 => (\dirname(__DIR__, 4).'/modules/ps_checkpayment/translations'),
                39 => (\dirname(__DIR__, 4).'/modules/ps_crossselling/translations'),
                ...
                67 => (\dirname(__DIR__, 4).'/modules/pleasewait/translations'),
                68 => (\dirname(__DIR__, 4).'/modules/ets_megamenu/translations'),
                69 => (\dirname(__DIR__, 4).'/modules/ets_multilayerslider/translations'),
                70 => (\dirname(__DIR__, 4).'/modules/ets_reviewticker/translations'),
                71 => (\dirname(__DIR__, 4).'/modules/ybc_newsletter/translations'),
                72 => (\dirname(__DIR__, 4).'/modules/ets_mailchimpsync/translations'),
            ],
            ...
            'kernel.secret' => 'd9kXhwXIoBipGDAMIyJ2nx1BcYotHMTo7UefRxZDo5949guRe0wkh3vOdDsPtxTC',
